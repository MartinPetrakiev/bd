...
CREATE DATABASE furniture_company COLLATE LATIN1_GENERAL_100_CI_AS_SC_UTF8
GO
...
ALTER TABLE ORDER_LINE ADD  PRIMARY KEY (ORDER_ID, PRODUCT_ID);
...
SELECT custmr.CUSTOMER_NAME, SUM(prod.STANDARD_PRICE * ord_l.ORDER_QUANTITY) as 'Order Amount'
